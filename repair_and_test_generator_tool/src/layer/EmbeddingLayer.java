...
//	int output_dim;
	...
	public EmbeddingLayer(//int input_dim, int output_dim, 
			Object weights, List<Integer> inputShape, LinkedHashMap<String, String> params) {
...
//	}
	...
	public  String toString() {
		return "keras.layers."+name.replace("_", "")+"("+this.parameterString()+")";//input_dim+", "+output_dim+", "+this.parameterString()+")";
	}
...
//	}
	...
	public  String toPrologString(Object in) {
		...
		return name.toLowerCase()+"_layer("+ListHelper.printList(in)+ ", "+ par +ListHelper.printList(weights)+", "+"X)";
	}
...
//		o.put("input_dim",input_dim);
//		o.put("output_dim",output_dim);
		if(omitInputsAndWeights) {
			o.put("weight_shape", ListHelper.getShapeString(getWeights()));
		}
		else {
			o.put("weights", ListHelper.printList(getWeights()));
		}
		return o;
	}
