...
//	}
	...
	public JSONObject toJsonObject(boolean includeInOuputNodes, Map<String,Object> input, boolean omitInputsAndWeights) {
		...
		o.put("nodes", ""+nodeNumber);
		if(omitInputsAndWeights) {
			o.put("weight_shape", ListHelper.getShapeString(getInputWeights()));
			o.put("bias_shape", ListHelper.getShapeString(getOutputWeights()));
			if(inputWeights1 != null) {
				o.put("weight1_shape", ListHelper.getShapeString(getInputWeights1()));
			}
		}
		else {
			o.put("weights", ListHelper.printList(getInputWeights()));
			o.put("bias", ListHelper.printList(getOutputWeights()));
			if(inputWeights1 != null) {
				o.put("weights1", ListHelper.printList(getInputWeights1()));
			}
		}
		return o;
	}
