...
public class RecurrentLayer extends NodeLayer {
	...
	public JSONObject toJsonObject(boolean includeInOuputNodes, Map<String,Object> input, boolean omitInputsAndWeights) {
		...
		if(omitInputsAndWeights) {
			o.put("recurrent_weight_shape", ListHelper.getShapeString(getRecurrentWeights()));
		}
		else {
			o.put("recurrent_weights", ListHelper.printList(getRecurrentWeights()));
		}
		return o;
	}
	...
	public List<Integer> getOutputShape(){
		List<Integer> outputShape = new ArrayList<Integer>();
		outputShape.add(0,1);
