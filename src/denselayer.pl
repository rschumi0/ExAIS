%?- dense_layer2D([4,9],[[5,8],[7,6]],[4,3],X). 
% X = [87, 89] 

%?- dense_layer_randIs(2,10,[[5,8],[7,6]],[4,3],X).
%X = [60, 77] 

%?- dense_layer3D([1,2,3],[[2,3,4],[5,4,6],[7,6,8]],[2,3,4],X).
% X = [35, 32, 44] 

% ?-dense_layer3D([4,3,4,5],[[5,8,5],[7,6,6],[3,5,7],[3,5,4]],[4,3,5,6],X).
% X = [72, 98, 91] 

% ?- dense_layer3D([4,3,4,5,6],[[5,8,5],[7,6,6],[3,5,7],[3,5,4],[3,4,5]],[4,3,5,6,7],X).
% X = [90, 122, 121] 
